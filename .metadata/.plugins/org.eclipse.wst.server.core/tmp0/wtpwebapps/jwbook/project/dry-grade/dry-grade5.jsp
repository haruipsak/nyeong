...
<div class="container">
  ...
  <div class="nav-scroller py-1 mb-2">
    <nav class="nav d-flex justify-content-around" style="text-align:center">
      ...
      <a class="p-2 link-secondary nav-font-color" href="../question-list.jsp">건의사항</a>    </nav>
  </div>
</div>
        ...
        <p>
 		...
 		<table class="table" style="font-size:14px" >
 			<tr>
                ...
                <th style="text-align:center"> 그레인프리<br />
                ...
                <th style="text-align:center">탄수화물(%)<br/>
                 ...
                 <th style="text-align:center">냥바냥<br/>등급</th>
             </tr>
            
         <%  while (rs.next()) {
			if (rs.getInt("grade") == 5) { %>
