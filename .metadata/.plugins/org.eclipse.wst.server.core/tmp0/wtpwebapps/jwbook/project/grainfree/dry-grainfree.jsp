...
<main class="container">
  <div class="p-4 p-md-5 mb-4 rounded" style="background-color:#252221">
    <div class="col-md-10 px-0">
      <h1 class="display-4 fst-italic" style="color:white">그레인프리? 넌-그레인프리?</h1>
      <p class="lead my-3" style="color:white">알러지를 유발할 수 있는 곡물을 제외한 사료를 정리해 보여드립니다.</p>
    </div>
  </div>
        ...
        <p>
 		<table class="table" style="font-size:14px" >
 			 <tr>
                ...
                <th style="text-align:center"> 그레인<br />프리<br /></th>
                <th style="text-align:center">주성분<br />
	                ...
	                <a href="?sort=first&free&order=desc"><img src="https://cdn-icons-png.flaticon.com/512/8140/8140720.png" alt="오름" style="width:20px" /></a></th>
                <th style="text-align:center">탄수화물(%)<br/>
                 ...
                 <th style="text-align:center">냥바냥<br/>등급 <br />
	                 <a href="?sort=grade&order=asc"><img src="https://cdn-icons-png.flaticon.com/512/8140/8140579.png" alt="내림" style="width:20px" /></a>
		             <a href="?sort=grade&order=desc"><img src="https://cdn-icons-png.flaticon.com/512/8140/8140720.png" alt="오름" style="width:20px" /></a></th>
             </tr>
            
         <%  while (rs.next()) {
			if (rs.getInt("grainfree") == 1) { %>
