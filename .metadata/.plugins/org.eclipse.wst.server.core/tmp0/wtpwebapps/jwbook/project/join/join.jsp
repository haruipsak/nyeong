...
<main class="container">
   <div class="title login-box" ><h1 style="font-size: 30px;">회원가입</h1>
   <img src="https://i.esdrop.com/d/f/bkx1JZ8DmV/YyuOnf7Vox.png" style="width: 200px" alt="몰로"/>
   </div>
    <form action="join-ok.jsp" method="post">    
        <div class="join login-box">
            <label class="">아이디</label> <input name="id"  type="text" placeholder="아이디">
        ...
        <div class="join login-box">
           <label class="">이메일 주소</label> <input name="email" type="text" placeholder="이메일 주소">
            <div id="emailError" class="error"></div>
        </div>
        <div class="box" >       
            <input id="submit" class="btn btn-sm btn-outline-secondary login-hover" type="submit" value="회원가입" style="margin-right:10px">
            <input type="button" class="btn btn-sm btn-outline-secondary login-hover" onclick="location.href='../mainhome.jsp'" value="뒤로가기">
         </div>
       </form>
