...
<main class="container">
    ...
    <div class="board_wrap">
        ...
        <div class="board_write_wrap blog-header">
                  <div class="board_write">
                   <%
					...
					<table style="margin:10px; width:1200px" class="blog-header">
						<tr class="blog-header">
							<td>제목</td>
							<td><%=list.get(num).getSubject()%></td>
						</tr>
						<tr  class="blog-header">
							<td>닉네임</td>
							<td><%=list.get(num).getName()%></td>
							<td>작성일</td>
							<td><%=list.get(num).getDate()%></td>
						</tr>
						<tr class="blog-header"> 
							<td style="height:300px;">내용</td>
							<td><%=list.get(num).getContent()%></td>
						</tr>
					</table>
 
                <a class="btn btn-sm btn-outline-secondary login-hover" style="margin-botton: 10px;"  href="question-li.jsp">뒤로가기</a> 
