...
<main class="container">
   <div class="title login-box" ><h1 style="font-size: 30px;">로그인 실패!</h1>
   <img src="https://i.esdrop.com/d/f/bkx1JZ8DmV/7X8f26fdJ7.png" alt="아로아웅" style="width: 300px"/> <br />
   <div>아이디 또는 비밀번호가 잘못되었습니다.</div>
      <div>확인 후 다시 시도해주세요.</div>
	<a class="btn btn-sm btn-outline-secondary login-hover" href="login.jsp">로그인</a> 
</div>
</main>
</body>
</html>