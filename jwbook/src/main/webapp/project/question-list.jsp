...
<main class="container">
          <div class="card">
            ...
            <%
					...
					<tr>
						...
						<td style="text-align:center"><a class="basic-color" href="question-in.jsp?num=<%=list.get(i).getNum()%>"><%=list.get(i).getSubject()%></a></td>
        ...
        <div style="display: inline-block; float:right; ">
            <a class="btn btn-sm btn-outline-secondary login-hover" href="question.jsp" style="margin: 10px;">글쓰기</a>  
        </div>
        </div>
</main>
